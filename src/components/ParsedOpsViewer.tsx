...
import { Cpu, ChevronDown, ChevronUp, Code2, Scissors, Gauge, VolumeX, Eye, RotateCw, Volume2, Sparkles } from 'lucide-react';
    ...
    <div className="glass-panel rounded-2xl p-5 border border-slate-800 space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs text-slate-400 hover:text-slate-200 flex items-center gap-1 px-2 py-1 rounded bg-slate-800/60 border border-slate-700/60"
        >
      ...
      {instructions.explanation && (
        <div className="p-3 rounded-xl bg-indigo-950/40 border border-indigo-500/20 flex items-start gap-2.5 text-xs text-indigo-200">
      ...
      <div className="flex flex-wrap gap-2 pt-1">
        ...
        {typeof instructions.volume === 'number' && !instructions.mute && (
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-800/80 border border-slate-700 text-xs text-slate-200">
      ...
      {isOpen && (
        <div className="space-y-2 pt-2">
          <div className="flex items-center justify-between text-xs text-slate-400">
            <span>JSON Output format delivered to FFmpeg runner:</span>
          </div>
